package com.example.securestash.ExternalPackages;
...
import com.example.securestash.PDFDecoder;
...
public class PDFPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setRegionDecoderFactory(() -> new PDFRegionDecoder(position, file, scale, Color.TRANSPARENT));
